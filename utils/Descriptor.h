...
: public DescriptorStub
{
    ...
    public:
        ...
        static LV2_Handle _instantiate(const LV2_Descriptor* d, double samplerate, const char* bundle_path, const LV2_Feature* const* features)
        ...
        static void _deactivate (LV2_Handle h)
            {
